-- source: https://github.com/JoosepAlviste/dotfiles/blob/master/config/nvim/lua/j/plugins/telescope.lua#L75
...
M.actions = transform_mod {
  ...
  set_folders = function(prompt_bufnr)
    ...
    pickers.new({}, {
      ...
      attach_mappings = function(grep_bufnr)
        action_set.select:replace(function()
          current_picker = action_state.get_current_picker(grep_bufnr)
